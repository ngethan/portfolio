        ...
        <motion.div variants={itemY}>
            ...
            >
                <p
                    className={
                        noName
                            ? "invisible opacity-0 px-[10px] fixed group-hover:visible group-hover:opacity-100 w-fit h-[20] bg-gray-700 rounded duration-300 left-[50%] bottom-[60px] -translate-x-1/2 z-[100]"
                            : "invisible fixed"
                    }
                >
                    {name}
                ...
                <div
                    className={
                        !noName
                            ? "skill font-code h-[75px] items-center w-fit flex flex-row"
                            : "skill font-code h-[60px] items-center w-fit flex flex-row"
                    }
                >
                    <Icon
                        size={!noName ? 50 : 30}
